...
class TestOrderRecord(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OrderRecord:
        """Test OrderRecord
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderRecord`
        """
        model = OrderRecord()
        if include_optional:
            return OrderRecord(
